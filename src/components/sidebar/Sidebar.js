    ...
    <div className="sidebar">
      <div className="mes-logo">
        <svg
          ...
          width="30"
          height="30"
          viewBox="0 0 27.094 20.346"
        >
          <g id="factoryIcon" transform="translate(-31.444 -63.971)">
            <path
              id="Path_79"
              data-name="Path 79"
              d="M-225,921.317h8.442V900.971l-8.442,7.01Z"
              transform="translate(256.444 -837)"
            ...
            <path
              ...
              data-name="Path 80"
              d="M-225,921.317h8.442V900.971l-8.442,7.01Z"
              transform="translate(265.77 -837)"
            ...
            <path
              ...
              data-name="Path 81"
              d="M-225,921.317h8.442V900.971l-8.442,7.01Z"
              transform="translate(275.096 -837)"
              fill="#fff"
            />
          </g>
        </svg>
            ...
            >
              <g id="Dashboard" transform="translate(-5.404 -5.404)">
                <path
                  ...
                  data-name="Path 72"
                  d="M5,5h9.82v9.82H5Z"
                  transform="translate(1.404 1.404)"
                  fill="none"
                  stroke="#fff"
                ...
                <path
                  id="Path_73"
                  data-name="Path 73"
                  d="M23.333,5h9.82v9.82h-9.82Z"
                  transform="translate(-2.557 1.404)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  id="Path_74"
                  data-name="Path 74"
                  d="M23.333,23.333h9.82v9.82h-9.82Z"
                  transform="translate(-2.557 -2.557)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  id="Path_75"
                  data-name="Path 75"
                  d="M5,23.333h9.82v9.82H5Z"
                  transform="translate(1.404 -2.557)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div className="icon-list">
            ...
            >
              <path
                id="Path_410"
                data-name="Path 410"
                d="M0,0H30.261V30.261H0Z"
                fill="none"
              />
              <path
                id="Path_411"
                data-name="Path 411"
                d="M7.876,11.519h3.643V7.876l-4.25-4.25a7.286,7.286,0,0,1,9.715,9.715l7.286,7.286a2.576,2.576,0,0,1-3.643,3.643l-7.286-7.286A7.286,7.286,0,0,1,3.626,7.269l4.25,4.25"
                transform="translate(1.186 1.186)"
                fill="none"
                stroke="#fff"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="icon-list">
            ...
            >
              ...
              <path
                id="Path_415"
                data-name="Path 415"
                d="M22,8v6.875a6.875,6.875,0,0,1-6.875,6.875H11l4.125-4.125m0,8.25L11,21.75"
                transform="translate(4.125 3)"
                fill="none"
                stroke="#fff"
                stroke-linecap="round"
                stroke-linejoin="round"
              ...
              <path
                id="Path_416"
                data-name="Path 416"
                d="M5,20.875V14a6.875,6.875,0,0,1,6.875-6.875H16L11.875,3m0,8.25L16,7.125"
        ...
        <div className="flexBox">
          <div className="icon-list">
            <svg
              ...
              width="21"
              height="21"
              viewBox="0 0 24.395 30.396"
            >
              <g id="reports" transform="translate(-6.998 -4.195)">
                <path
                  id="Path_676"
                  data-name="Path 676"
                  d="M11.4,5H8.2A3.2,3.2,0,0,0,5,8.2v19.2a3.2,3.2,0,0,0,3.2,3.2h16a3.2,3.2,0,0,0,3.2-3.2V8.2A3.2,3.2,0,0,0,24.2,5H21"
                ...
                <rect
                  ...
                  height="6"
                  rx="2"
                  transform="translate(14.195 5.195)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  ...
                  data-name="Path 677"
                  d="M9,20V12"
                  transform="translate(5.396 7.195)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  ...
                  data-name="Path 678"
                  d="M12,17.6V16"
                  transform="translate(7.195 9.594)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  ...
                  data-name="Path 679"
                  d="M15,18.8V14"
                  transform="translate(8.994 8.395)"
                  fill="none"
                  stroke="#fff"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div className="icon-list">
            ...
            >
              ...
              <path
                id="Path_413"
                data-name="Path 413"
                d="M12,4.619a2.119,2.119,0,0,1,4.118,0,2.119,2.119,0,0,0,3.163,1.31A2.12,2.12,0,0,1,22.2,8.842,2.119,2.119,0,0,0,23.506,12a2.119,2.119,0,0,1,0,4.118,2.119,2.119,0,0,0-1.31,3.163A2.12,2.12,0,0,1,19.283,22.2a2.119,2.119,0,0,0-3.161,1.309,2.119,2.119,0,0,1-4.118,0A2.119,2.119,0,0,0,8.841,22.2a2.12,2.12,0,0,1-2.913-2.913,2.119,2.119,0,0,0-1.309-3.161,2.119,2.119,0,0,1,0-4.118,2.119,2.119,0,0,0,1.31-3.163A2.12,2.12,0,0,1,8.842,5.928,2.117,2.117,0,0,0,12,4.619Z"
          ...
          <div className="icon-list">
            ...
            >
              ...
              <path
                id="Path_429"
                data-name="Path 429"
                d="M17.208,9.167V6.583A2.583,2.583,0,0,0,14.625,4H5.583A2.583,2.583,0,0,0,3,6.583v15.5a2.583,2.583,0,0,0,2.583,2.583h9.042a2.583,2.583,0,0,0,2.583-2.583V19.5"
                transform="translate(0.875 1.167)"
                fill="none"
                stroke="#fff"
                stroke-linecap="round"
                stroke-linejoin="round"
              ...
              <path
                id="Path_430"
                data-name="Path 430"
                d="M7,12.875H25.083L21.208,9m0,7.75,3.875-3.875"
                transform="translate(2.042 2.625)"
                fill="none"
                stroke="#fff"
                stroke-linecap="round"
                stroke-linejoin="round"
